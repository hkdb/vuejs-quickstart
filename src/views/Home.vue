    ...
    <div class="section">
      <div class="container">
        <div class="content">
          ...
          <hr>
          <h4><b>Create</b> project: </h4>
          Clone or download the project, <a href="https://github.com/hkdb/vuejs-quickstart/archive/master.zip">here</a>. Then,
          <pre>
            $ mv vuejs-quickstart (project name)
            $ cd (project name)
            $ rm -rf .git
            $ yarn install
          </pre>
